def main(): 
    ...
    pinCode = ["1234", "5678", "2424", "1985", "5555"] #data of the account holders 

    accountHoldersName = ["aayush gautam", "john grown", "kevin durant", "serena williams", "david guetta"] 
